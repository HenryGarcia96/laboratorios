                ...
                <div class="card-body">
                  ...
                  <div class="row mb-1">
                    <div class="mb-3 col-md-4">
                      ...
                      <select class="js-example-basic-single form-select" name="servicio" data-width="100%">
                        <option></option>
                        <option value="TX">Empresa de publicidad</option>
                        <option value="NY">Empresa particular</option>
                      </select>
                    ...
                    <div class="mb-3 col-md-4">
                      ...
                      <select class="js-example-basic-single form-select" name="tipPasiente" data-width="100%">
                        <option></option>
                        <option value="TX">Empresa de publicidad</option>
                        <option value="NY">Empresa particular</option>
                      </select>
                    ...
                    <div class="mb-3 col-md-4">
                      ...
                      <select class="js-example-basic-single form-select" name="turno" data-width="100%">
                        <option></option>
                        <option value="TX">Empresa de publicidad</option>
                        <option value="NY">Empresa particular</option>
                      </select>
